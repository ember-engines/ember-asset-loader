...
function testStringGenerator(sourceJSON) {
  return (
    '<meta name="testing/config/asset-manifest" content="' +
    metaHandler.transformer(sourceJSON) +
    '" />'
  );
}
...
describe('meta-handler', function () {
  describe('replacer', function () {
    ...
    it('only replaces the first occurrence', function () {
      ...
      var after = [testStringGenerator(replacement), before[1]];
    ...
    it('supports newlines', function () {
      ...
      var after = [before[0], testStringGenerator(replacement), before[2]];
